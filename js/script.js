...
$(function() {
    ...
    if(!!query) {
        ...
        $tips.html('Let me tell you HOW TO USE GOOGLE. ');
        $stop.fadeIn();
        
        stepTimeout = setTimeout(function() {
            $tips.html('1, Find the input form');
    ...
    $('#search-form').submit(function() {
        ...
        if(!question) {
            ...
            $tips.html('↓↓↓ Copy The url and Tell Your friends How to Use fantastic the Search Engine.');
            $('#output').fadeIn();
